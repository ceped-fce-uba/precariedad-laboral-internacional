...
Metadata <- read_excel("../Metadata.xlsx", sheet = "Encuestas Utilizadas")
...
```{r }
Metadata <- read_excel("../Metadata.xlsx", sheet = "Diccionario")
Metadata %>% 
...
Homogeneizacion <- read_excel("../Metadata.xlsx", sheet = "Homogeneizacion")
```
